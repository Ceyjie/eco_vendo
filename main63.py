...
def servo_pwm_thread():
    ...
    pulse_count = 0
    MAX_PULSES  = 75   # 75 pulses at 50Hz = 1.5s — matches servo_goto hold time
...
def servo_goto(deg, hold=1.6):
    """Move servo to angle. hold must be >= MAX_PULSES/50 seconds."""
...
def _process_bottle_inner():
    ...
    if pts > 0:
        ...
        # Wait for bottle removal — servo goes to 90 AS SOON as weight drops
        ...
        # Return servo to 90° standby immediately after removal
        servo_goto(90, hold=1.6)
